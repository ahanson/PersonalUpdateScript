...
# Other things to install: Litecoin, Haroopad, Dropbox.
function install_basic_programs {
SOFTWARE=('abook' 'artha' 'audacity' 'baobab' 'beets' 'beets-docs' 'bleachbit' 'bmon' 'brasero' 'buzztard' 'catfish' 'dosbox' 'dos2unix' 'dropbox' 'fdupes' 'filezilla' 'fslint' 'gdebi' 'geany' 'giada' 'gimp' 'git' 'gnome-clocks' 'gnome-schedule' 'gparted' 'gsmartcontrol' 'gtypist' 'hardinfo' 'htp' 'htop' 'i7z' 'inxi' 'isomaster' 'inkscape' 'ipscan' 'jekyll' 'keepassx' 'links' 'lyx' 'meld' 'mercurial' 'milkytracker' 'mixxx' 'mocp' 'mosh' 'pdfmod' 'pdfshuffler' 'puddletag' 'pyrenamer' 'ruby' 'shellcheck' 'skypeforlinux' 'soundconverter' 'sqliteman' 'sqlitebrowser' 'steam' 'syncthing-gtk' 'testdisk' 'transmission-gtk' 'tuxboot' 'ubuntu-make' 'unetbootin' 'virtualbox' 'virtualbox-qt' 'vlc' 'wordgrinder' 'wine' 'winetricks' 'wireshark' 'xfburn' 'zenmap')
